        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                { 
                    ...
                    value: '> Убедитесь, что ник не содержит специальных символов. Допускаются никнеймы только с буквами и цифрами\n' +
                           '> Также убедитесь, что привязываете дискорд на сервере через **профиль игрока**, а не через команду /discord.', 
                    inline: false 
                }
            )
